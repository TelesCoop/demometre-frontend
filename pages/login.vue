...
const isMailValid = computed(() => isEmailUntouched.value || !emailErrorMessage.value)
    ...
    <div class="is-flex flex-center">
        <div class="sm-container">
            ...
            <div class="field">
                ...
                <p v-if="!isMailValid" class="help is-danger">{{ emailErrorMessage }}</p>
            </div>
            ...
            <div class="field">
                ...
                <p v-if="!isPasswordValid" class="help is-danger">{{ passwordErrorMessage }}</p>
            </div>

            <!-- submit -->
            <div class="mt-4">
                <button class="button is-success is-medium" @click="submit" type="button">Connexion</button>
            </div>
        </div>
    </div>
</template>
